...
p.add_argument('--experiment_name', type=str, required=False, default="dubins3D",
...
p.add_argument('--tMax', type=float, default=1.1, required=False, help='End time of the simulation')
...
# Define the loss
loss_fn = loss_functions.initialize_hjb_dubins3D(dataset, opt.minWith)
